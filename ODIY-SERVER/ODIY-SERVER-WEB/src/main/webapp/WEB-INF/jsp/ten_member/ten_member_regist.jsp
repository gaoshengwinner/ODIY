	...
	<div class="login-page">
		<div class="form">
			<form class="register-form">
				<input type="text" placeholder="メールアドレス" /> <input type="password"
					placeholder="パースワード" /> <input type="text"
			...
			<form class="login-form">
				<h3
					style="border-left: 6px solid #00BFFF; padding: 0px 2px 0px 10px;">食注会員ログイン</h3>
				<input type="text" placeholder="メールアドレス" /> <input type="password"
					placeholder="パースワード" />
				<button>登録</button>
				<p class="message">
					会員まだありませんか? <a href="#">会員作成します</a>
				</p>
			</form>
		</div>
	</div>
